...
class LaunchRequestHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        speak_output = "Bem vindo, Pedro!"
        reprompt     = "Quando tu nasceu?"
...
class CaptureBirthdayIntentHandler(AbstractRequestHandler):
    ...
    def can_handle(self, handler_input):
        ...
        return ( 
            ...
            ask_utils.is_intent_name( "CaptureBirthdayIntent")(handler_input) 
        )
    ...
    def handle(self, handler_input):
        ...
        speechText = f'Obrigado, lembrarei que seu aniversário é {day} de {month} de {year}.'
